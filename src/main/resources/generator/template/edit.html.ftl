...
<article class="page-container">
    <form class="form form-horizontal" id="form-${entity?uncap_first}-edit" action="#"
          th:action="@{/${package.ModuleName}/${entity?uncap_first}/edit}" th:object="${r"$"}{${entity?uncap_first}}" enctype="multipart/form-data">
                       ...
                       <#elseif field.type == 'text'>
                        ...
                        <#else>
                            <div class="formControls col-xs-10 col-sm-10">
                                ...
                                <input type="file" multiple="" style="width:100%; height:100%" th:value="${r"$"}{${entity?uncap_first}.${field.propertyName}}" name="${field.propertyName}File"   id="${field.propertyName}" class="input-file valid">
                                <br/>
                                <img th:src="@{{path}(path=${r"$"}{${entity?uncap_first}.${field.propertyName}})}" style=" width:100xp; height:100px;"/>
                                <#else>
